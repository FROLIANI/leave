   ...
   <fieldset >
     ...
     <table class="table table-striping" >
      <form class="form-control" action="employee.php" method="post">
      	<tr><td colspan="4"> <h2>RESET EMPLOYEE PASSWORD</h2> </td></tr>
      <tr> 
     ...
     <tr>
        <td colspan="3"><button  class="button" name="login"> <span class="glyphicon glyphicon-log-in"> RESET</span></button> </td>
      </tr>
